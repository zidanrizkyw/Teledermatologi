            ...
            <Container className='bg-light h-100 w-100 rounded-4 d-flex justify-content-center mt-3'>
                <Row>
                    <Col className='mt-5'>
                        ...
                        <hr></hr>
                        <Nav.Link className='btnsidebar' href='/DashboardAdmin'>
                            <FontAwesomeIcon className="iconawesome2" icon={faHouse} size='2x' />
                            <h5 style={{ display: isOpen ? "block" : "none" }} >Dashboard</h5>
                        </Nav.Link>
                        <br></br>
                        <Nav.Link className='btnsidebar' href='/AddDoctor'>
                            <FontAwesomeIcon className="iconawesome3" icon={faPlus} size='2x' />
                            <h5 style={{ display: isOpen ? "block" : "none" }} >Add Doctor</h5>
                        </Nav.Link>
                    </Col>
                </Row>
            </Container>
...
export default SidebarDashAdmin 