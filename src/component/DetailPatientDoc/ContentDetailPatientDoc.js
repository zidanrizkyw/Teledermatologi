...
function ContentDetailPatientDoc() {
    return (
                ...
                <Row>
                    <Col className='myscrollbar'>
                        <Col className='mt-3 mb-3 d-flex'>
                            ...
                            <div className='infopatientbutton d-flex align-items-center'>
                            <Button variant="success" className='infopatientbutton1'>Confirm</Button>{' '}
                            <Button variant="danger" className='infopatientbutton2'>Cancel</Button>{' '}
                            </div>
                        </Col>
...
export default ContentDetailPatientDoc